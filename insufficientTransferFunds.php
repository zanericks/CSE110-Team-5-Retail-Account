<html>
  ...
  <body>
    ...
    <p align="center"><font color="#FF0000">Insufficent Funds to Transfer! Please deposit more money into your account!</font></p>
...
<br>
    ...
    Note: Just type number (ex: 50). You do not need a $ sign.</p></div><br>
    <div id="submit"><input type="submit" value="Transfer" style="background-color:Green; color:White; border:2px solid Green"/>  
